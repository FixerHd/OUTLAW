...
public class recolecta : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (salami1.IsDestroyed() && salami2.IsDestroyed() && salami3.IsDestroyed() && salami4.IsDestroyed() && salami5.IsDestroyed() && salami6.IsDestroyed() && salami7.IsDestroyed() && salami8.IsDestroyed()) SceneManager.LoadScene("finalmalo");
